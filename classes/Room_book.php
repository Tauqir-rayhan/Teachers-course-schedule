...
public function insert(){
       $sql = "INSERT INTO $this->table(building,room_number,time_slot_id,day,Start_time,Status,T_ID) VALUES(:building,:room_number,:time_slot_id,:day,:Start_time,:Status,:T_ID)";
       $stmt = DB::prepare($sql); 
       ...
       header("Location: room_book.php?msg=");
       return $stmt->execute();
  }
     
public function update($T_ID)
{
    $sql="UPDATE $this->table SET building=:building,room_number=:room_number,time_slot_id=:time_slot_id,day=:day,Start_time=:Start_time,Status=:Status,T_ID=:T_ID WHERE T_ID=:T_ID";
