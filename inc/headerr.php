...
<div class="phpcoding">
 <section class="headeroption">
  ...
  <h2><?php echo "Teacher information"; ?></h2>
 </section>
  <section class="maincontent">
  <section class="subject">
<p> <span style="float:right"><a href="student.php">For Student</a> || <a href="index.php">For Teacher</a> || <a href="request.php">Request</a></span>|| <a href="room_status.php">Room</a></span>|| <a href="room_book.php">Room_Book</a></span>|| <a href="notice.php">Notice</a></span>|| <a href="teaches.php">Teaches</a><p>
</section>
