...
?>
    ...
    <tr>
        ...
        <td>
            <?php echo "<a href='requestedit.php?action=update&T_ID=".$value['T_ID']."'>Edit</a>";?> ||
             <?php echo "<a href='requestedit.php?action=delete&T_ID=".$value['T_ID']."' onClick='return confirm(\"Are you sure to Delete Data\")'>Delete</a>";?> 
        </td>
